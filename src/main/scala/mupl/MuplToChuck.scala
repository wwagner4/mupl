...
object MuplToChuck {
  ...
  def convert(vars: Seq[Variable]): String = {
    """
      ...
      |    fun Sound[] sounds() {
      |        return [
      |            nop(), pl(1, 0.3, 55),pl(2, 1.0, 58),pl(2, 1.0, 56),pl(1, 0.3, 59),pl(2, 0.3, 58),pl(2, 0.3, 58),pl(1, 0.3, 55),pl(2, 1.0, 58),pl(2, 1.0, 56),pl(1, 0.3, 59),pl(1, 0.3, 58)
      |        ];
      |    }
      |}
      ...
      |    fun Sound[] sounds() {
      |        return [
      |            nop(), pl(1, 1.0, 39), pa(1), pl(1, 1.0, 44), pa(1), pl(1, 1.0, 39), pa(1), pl(2, 0.3, 44), pl(2, 0.3, 39), pa(1) 
      |        ];
      |    }
      |}
      ...
      |    }
      |}
      |fun void m1() { m1Melody m; m.play(); }
      |fun void m2() { m2Melody m; m.play(); }
      |fun void p1() { p1Melody m; m.play(); }
      |fun void par01() {
      |    m1(); m1();
      |}
      |fun void par02() {
      ...
      |}
      |fun void par() {
      |    spork ~ par01(); spork ~ par02(); spork ~ par03();
      |}
      |if (me.args() != 1) {
